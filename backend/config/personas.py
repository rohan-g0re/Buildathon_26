...
IMPORTANT: Start your response IMMEDIATELY with the first --- delimiter.
Do NOT include any introduction, preamble, or summary before the first move.
"""
...
SCORING_PROMPT = """
You have just completed a multi-round boardroom negotiation about this business move:
